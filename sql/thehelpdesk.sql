...
CREATE TABLE `category` (
  ...
  `category_color` varchar(20) COLLATE utf8_unicode_ci NOT NULL
...
(1, 'ฮาร์ดแวร์และอุปกรณ์ต่อพ่วง', '#FF8105'),
(2, 'อินเทอร์เน็ต(Internet Breakdown)', '#FF4242'),
(3, 'บำรุงรักษาระบบคอมพิวเตอร์(PM)', '#1CDAFF'),
(4, 'ระบบ Email', '#C9FF28'),
(5, 'ระบบโทรศัพท์ภายใน', '#75FF56'),
(6, 'ระบบเครือข่ายไร้สาย (Wifi)', '#2C21FF'),
(128, 'งานสร้างชิ้นงาน', 'E7FF0D');
...
(1, 'Y3lr8E4xmP58Rzd6GBhzvuOhxBFuG5yJVbbd4CB3HIs', '2021-04-05 11:18:31');
...
CREATE TABLE `repair` (
  ...
  `repair_code` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `employee_id` int(10) NOT NULL,
  `technician_id` int(10) NOT NULL,
  `repair_detail` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
  `repair_cause` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `category_id` int(10) NOT NULL,
  ...
  `uploadfiles` varchar(255) COLLATE utf8_unicode_ci DEFAULT 'ไม่มีไฟล์แนบ'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `repair` (`repair_id`, `repair_code`, `employee_id`, `technician_id`, `repair_detail`, `repair_cause`, `category_id`, `image_name`, `status_id`, `repair_date`, `uploadfiles`) VALUES
(36, '2104-05-0000', 999, 1036, 'เปิดเครื่องไม่ติด ไม่รู้เป็นอะไร ', 'ขัด RAM ให้หน่อครับบบบ', 1, 'loginbg.jpg', 2, '2021-04-05 12:55:13', 'Mail Office.txt');
...
INSERT INTO `tblusers` (`id`, `fullname`, `username`, `useremail`, `provinces_id`, `amphures_id`, `districts_id`, `role_id`, `password`, `regdate`) VALUES
(999, 'admin', 'admin', 'admin@localhost.com', '17', '204', '260307', 999, '123456789', '2021-04-05 11:28:49'),
(1036, 'พิพัฒน์', 'admina', 'tech@local', '3', '59', '120207', 2, '5988e261af498c643d9ab579917a46a2', '2021-04-05 11:44:46');
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `repair`
  MODIFY `repair_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
